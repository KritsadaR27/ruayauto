...
func (s *KeywordService) GetAllKeywords(ctx context.Context) ([]models.SimpleKeyword, error) {
...
func (s *KeywordService) CreateKeyword(ctx context.Context, keyword, response string) error {
	...
	// Create new keyword
	newKeyword := models.SimpleKeyword{
...
func (s *KeywordService) GetKeywordByID(ctx context.Context, id int) (*models.SimpleKeyword, error) {
	return s.repo.GetByID(ctx, id)
}

// SearchKeywords searches for keywords containing the search term
func (s *KeywordService) SearchKeywords(ctx context.Context, searchTerm string) ([]models.SimpleKeyword, error) {
...
func (s *KeywordService) FindMatchingKeyword(ctx context.Context, text string) (*models.SimpleKeyword, error) {
...
func (s *KeywordService) BulkUpdateKeywords(ctx context.Context, pairs []struct {
	...
	existingMap := make(map[string]models.SimpleKeyword)
